...
const personScoresRoutes       = require('./routes/person-scores');
const efficiencyPeriodsRoutes  = require('./routes/efficiency-periods');
const efficiencyCriteriaRoutes = require('./routes/efficiency-criteria');
const efficiencyEvalsRoutes    = require('./routes/efficiency-evaluations');
...
app.use('/api/person-scores',           personScoresRoutes);
app.use('/api/efficiency-periods',      efficiencyPeriodsRoutes);
app.use('/api/efficiency-criteria',     efficiencyCriteriaRoutes);
app.use('/api/efficiency-evaluations',  efficiencyEvalsRoutes);
